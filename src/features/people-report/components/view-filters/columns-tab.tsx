...
const ColumnsTab = <TData extends RowData>({
  ...
  const [hasSavedDefault, setHasSavedDefault] = useState(() => hasStoredFarmerReportColumnState());
  ...
  const handleSaveDefaultColumns = () => {
    const saved = saveFarmerReportColumnState(columnIds, draftColumnVisibility, draftColumnOrder);
