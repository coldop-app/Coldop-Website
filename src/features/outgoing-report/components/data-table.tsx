...
export const DataTable = memo(function DataTable({
  ...
  const searchIndex = useMemo(() => createOutgoingReportSearchIndex(data), [data]);
  ...
  const tableData = useMemo(
    () =>
      expandOutgoingReportRowsByVariety(filteredData, quantityMode, grouping.includes('variety')),
