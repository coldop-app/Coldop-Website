...
export const OUTGOING_REPORT_DOWNLOAD_EXCEL_MESSAGE = 'kf-outgoing-report-download-excel' as const;
...
export function openOutgoingReportPreview(options: PreviewOutgoingReportOptions): Window {
