      ...
      <View style={styles.body}>
        ...
        <View style={styles.panel}>
          <View style={styles.tableHeaderRow}>
            ...
            <Text style={[styles.col2, styles.colTextHeader]}>Storage Location</Text>
...
export default function IncomingGatePassReceiptPdf(props: IncomingGatePassReceiptPdfProps) {
  return (
    <Document
      author="Coldop"
