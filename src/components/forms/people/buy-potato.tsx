...
export interface BuyPotatoFormProps {
  onSuccess?: () => void;
  onCancel?: () => void;
...
const BuyPotatoForm = memo(function BuyPotatoForm({
  onSuccess,
  onCancel,
    ...
    >
      ...
      <FieldGroup className="space-y-2 sm:space-y-4">
          ...
          children={(field) => {
            ...
            return (
              <Field data-invalid={isInvalid} className="gap-1.5 sm:gap-3">
                <FieldLabel htmlFor="buy-potato-amount">
                  Amount (₹) <span className="text-destructive">*</span>
                </FieldLabel>
                <Input
                  id="buy-potato-amount"
                  name={field.name}
                  type="number"
                  inputMode="decimal"
                  step="any"
        ...
        <form.Field
          ...
          children={(field) => (
            <Field className="gap-1.5 sm:gap-3">
              <FieldLabel htmlFor="buy-potato-narration">Remarks</FieldLabel>
              <Input
                id="buy-potato-narration"
                name={field.name}
